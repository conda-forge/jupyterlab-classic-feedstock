...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jupyterlab-classic-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11567&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jupyterlab-classic-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jupyterlab-classic` can be installed with:

```
conda install jupyterlab-classic
```

It is possible to list all of the versions of `jupyterlab-classic` available on your platform with:
